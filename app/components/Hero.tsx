...
export default function Hero() {
  return (
    <section className="relative pt-12 pb-16 md:pt-20 md:pb-24 px-4 md:px-8 w-full min-h-auto md:min-h-[85vh] flex flex-col items-center justify-start md:justify-center text-center z-10 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto flex flex-col items-center w-full">
        ...
        <div className="hero-animate inline-flex items-center gap-2 bg-white/5 backdrop-blur-md border border-white/10 hover:border-[#ff4fd8]/40 transition-all rounded-full p-1 pl-3 md:pl-4 pr-1 mb-5 md:mb-8 max-w-full shadow-lg shadow-purple-950/20">
          ...
          >
            Explore Plans <ArrowRight size={11} />
          </Link>
        </div>
        ...
        <div className="hero-animate-delay-5 w-full max-w-3xl glass-card rounded-2xl p-5 sm:p-6 md:p-8 relative shadow-2xl backdrop-blur-xl border-white/10">
